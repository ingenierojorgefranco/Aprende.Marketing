...
export const HeroSection: React.FC<HeroSectionProps> = ({ onScrollTo }) => {
  return (
    <section id="inicio" className="grid md:grid-cols-12 gap-8 items-center mb-16 relative z-10 pt-20">
      
      {/* Columna Izquierda: Introducción y CTA */}
      <div className="md:col-span-8 space-y-6 text-left">
        <span className="inline-block text-[#FF5A1F] text-xs font-black tracking-widest uppercase leading-relaxed">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          <span className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#111] border border-white/10 rounded-full text-xs font-semibold text-gray-300">
        ...
        <div className="space-y-3 pt-4">
          ...
          <div className="grid grid-cols-2 gap-3.5 w-full max-w-[550px]">
            <a 
          ...
          <div className="relative bg-[#111111] border border-white/10 rounded-3xl p-5 space-y-5 text-center shadow-2xl">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs font-semibold text-[#FFBF00] uppercase tracking-widest flex items-center justify-center gap-1.5">
                <MapPin className="w-3.5 h-3.5 text-[#FF5A1F]" /> Málaga, España
              </p>
            </div>

            {/* Disponibilidad Badge */}
            <div className="pt-2 border-t border-white/5">
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-md text-xs font-black text-emerald-400">
