...
const BASE_DS: DesignSystem = {
    ...
    nav: { stickyBg: 'bg-white', stickyText: 'text-gray-900', transparentText: 'text-white', stickyBorder: 'border-gray-100', logoBg: 'bg-blue-600', logoText: 'text-white', linkHover: 'text-blue-600', mobileMenuBg: 'bg-white', mobileMenuText: 'text-gray-900', mobileMenuBorder: 'border-gray-100', ctaButton: 'bg-blue-600 text-white' },
  ...
  switch (palette) {
    case 'modern-blue': 
      return {
        ...
        nav: { stickyBg: 'bg-white/90 backdrop-blur', stickyText: 'text-slate-900', transparentText: 'text-white', stickyBorder: 'border-slate-100', logoBg: 'bg-blue-600', logoText: 'text-white', linkHover: 'text-blue-600', mobileMenuBg: 'bg-white', mobileMenuText: 'text-slate-900', mobileMenuBorder: 'border-slate-100', ctaButton: 'bg-blue-600 text-white' },
    ...
    case 'dark-luxury': 
      return {
        ...
        nav: { stickyBg: 'bg-black/90 backdrop-blur', stickyText: 'text-white', transparentText: 'text-white', stickyBorder: 'border-white/10', logoBg: 'bg-yellow-500', logoText: 'text-black', linkHover: 'text-yellow-500', mobileMenuBg: 'bg-black', mobileMenuText: 'text-white', mobileMenuBorder: 'border-white/10', ctaButton: 'bg-yellow-600 text-black font-bold' },
    ...
    case 'energetic-orange':
      return {
        ...
        nav: { stickyBg: 'bg-white/90 backdrop-blur', stickyText: 'text-gray-900', transparentText: 'text-gray-900', stickyBorder: 'border-orange-100', logoBg: 'bg-orange-600', logoText: 'text-white', linkHover: 'text-orange-600', mobileMenuBg: 'bg-white', mobileMenuText: 'text-gray-900', mobileMenuBorder: 'border-orange-100', ctaButton: 'bg-orange-600 text-white' },
    ...
    case 'ocean-teal':
      return {
        ...
        nav: { stickyBg: 'bg-white/90 backdrop-blur', stickyText: 'text-teal-900', transparentText: 'text-white', stickyBorder: 'border-teal-100', logoBg: 'bg-teal-600', logoText: 'text-white', linkHover: 'text-teal-600', mobileMenuBg: 'bg-white', mobileMenuText: 'text-teal-900', mobileMenuBorder: 'border-teal-100', ctaButton: 'bg-teal-600 text-white' },
    ...
    case 'crimson-red':
      return {
        ...
        nav: { stickyBg: 'bg-white/90 backdrop-blur', stickyText: 'text-rose-950', transparentText: 'text-white', stickyBorder: 'border-rose-100', logoBg: 'bg-red-700', logoText: 'text-white', linkHover: 'text-red-700', mobileMenuBg: 'bg-white', mobileMenuText: 'text-rose-900', mobileMenuBorder: 'border-rose-100', ctaButton: 'bg-red-700 text-white' },
    ...
    case 'corporate-slate':
      return {
        ...
        nav: { stickyBg: 'bg-white/95 backdrop-blur', stickyText: 'text-slate-900', transparentText: 'text-white', stickyBorder: 'border-slate-200', logoBg: 'bg-slate-800', logoText: 'text-white', linkHover: 'text-slate-600', mobileMenuBg: 'bg-white', mobileMenuText: 'text-slate-900', mobileMenuBorder: 'border-slate-200', ctaButton: 'bg-slate-800 text-white hover:bg-slate-700' },
    ...
    case 'minimal-mono':
      return {
        ...
        nav: { stickyBg: 'bg-white/90 backdrop-blur', stickyText: 'text-black', transparentText: 'text-black', stickyBorder: 'border-black/5', logoBg: 'bg-black', logoText: 'text-white', linkHover: 'text-black font-bold', mobileMenuBg: 'bg-white', mobileMenuText: 'text-black', mobileMenuBorder: 'border-gray-200', ctaButton: 'bg-black text-white hover:bg-gray-800' },
