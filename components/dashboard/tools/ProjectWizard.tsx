                            ...
                            <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
                                ...
                                <div className="bg-primary/5 border border-primary/20 p-6 rounded-2xl">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-3">
                                        <input 
                                            ...
                                            placeholder="Pega la URL de tu página de ventas (ej: Hotmart)..."
                                        />
                                        <button 
                                    ...
                                    <p className="text-[11px] text-gray-500 mt-3 italic">
                                        * La IA leerá tu página actual para autocompletar el nombre y la descripción profesional de tu proyecto.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        ...
                                        className="w-full bg-black border border-gray-700 rounded-xl px-4 py-3 text-white focus:border-primary outline-none h-40 resize-none transition-all placeholder:text-gray-700 leading-relaxed"
