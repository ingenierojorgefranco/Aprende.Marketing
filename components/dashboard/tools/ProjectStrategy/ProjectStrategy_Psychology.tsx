                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row gap-16 lg:items-center">
                                <div className="space-y-10 flex-1">
                                    ...
                                    <h3 className="text-4xl md:text-6xl font-black text-white leading-[1.1] tracking-tight">
                                        <EditableField 
                                            value={avatar.transformation_title || avatar.pain || (idx === 0 ? "Si buscas crear tu propio negocio y reinventarte profesionalmente" : idx === 1 ? "Si ya estás en el sector belleza y quieres dominar la técnica más top" : "Si te da miedo fallar por falta de experiencia pero buscas respaldo")}
