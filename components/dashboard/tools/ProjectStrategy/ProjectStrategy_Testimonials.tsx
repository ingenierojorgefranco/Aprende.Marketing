...
import { Phone, MoreVertical, Send, Smile, Star, MessageSquare, Zap, Save, X, Loader2, Sparkles, AlertTriangle, ArrowRight, Wand2, Check, PenTool, Globe, Play } from 'lucide-react';
