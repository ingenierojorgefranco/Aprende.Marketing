                    ...
                    <div className="lg:col-span-7 bg-[#0B0B0B] border border-gray-800 rounded-[3rem] p-10 shadow-xl relative overflow-hidden flex-1 min-h-[600px]">
                        ...
                        {isCurrentGenerated ? (
                            ...
                            <div className="relative z-10 space-y-10 animate-in fade-in duration-500 h-full flex flex-col">
                                <div className="flex items-center justify-between"><span className="bg-yellow-900/20 text-yellow-400 border border-yellow-900/50 px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-lg">Configurando: {localPilar || 'Nutrición'}</span><span className="text-white text-lg font-black uppercase tracking-widest">Correo del Día {activeEmail + 1}</span></div>
