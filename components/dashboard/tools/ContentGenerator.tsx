        ...
        {generationStatus === 'generating' && (
            <div className="h-full flex flex-col items-center justify-center py-20 space-y-12 animate-in fade-in duration-500">
                <div className="relative mb-4">
                    <div className="w-24 h-24 bg-purple-50 rounded-3xl flex items-center justify-center animate-pulse border border-purple-100">
                ...
                <div className="w-full max-w-md space-y-4">
                    ...
                    <div className="w-full h-5 bg-gray-100 rounded-full overflow-hidden border border-gray-200 shadow-inner relative">
                        <div 
                            className="h-full bg-gradient-to-r from-purple-600 to-pink-400 transition-all duration-300 ease-out shadow-lg relative"
