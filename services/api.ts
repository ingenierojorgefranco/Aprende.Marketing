  ...
  createProject: async (project: Omit<Project, 'id' | 'createdAt'>): Promise<Project> => {
    ...
    getArticles: async (): Promise<Article[]> => {
        ...
        const mapped = articles.map((a: any) => ({
            ...
            isGenerated: a.isGenerated !== undefined ? !!a.isGenerated : !!a.is_generated,
            isUnlocked: a.isUnlocked !== undefined ? !!a.isUnlocked : !!a.is_unlocked,
    ...
    getSubscriptionSuccessDetails: async (queryParams: Record<string, string>): Promise<any> => {
        ...
        const calculatedAmount = queryParams.price 
        ...
        return {
            ...
            plan: {
                id: 'pro',
                name: isAnnual ? 'Plan Pro Anual' : 'Plan Pro All-Access',
                slug: isAnnual ? 'annual' : 'pro',
