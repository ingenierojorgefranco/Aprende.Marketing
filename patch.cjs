const fs = require('fs');
const file = 'components/landingpage/templates/ClassicSalesTemplate.tsx';
let content = fs.readFileSync(file, 'utf8');

const targetStr = `                     <div className="mb-10 space-y-3 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl p-5 shadow-xl">
...
const replacement = `                     <CtaBlockModule content={content} ds={ds} isMobilePreview={isMobilePreview} pageId={pageId} basePath={basePath} project={project} />
