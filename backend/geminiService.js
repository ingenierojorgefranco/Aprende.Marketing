    ...
    try {
       ...
       Actúa como un Copywriter Senior experto en Marketing de Respuesta Directa. Tu misión es redactar una secuencia de titulos y contenidos de 7 correos electrónicos (Día 0 al Día 6) diseñada para convertir prospectos en compradores del producto
        ...
        Instrucciones para landingPageTabs, genera copy persuasivo para 3 momentos:
            h1: "Añade un titulo Profesional altamente persuasivo que llame la atención de la audiencia enfocado en el beneficio de los avatares (incluye el nicho del producto dentro del titulo pero con el nombre del proyecto projectName, el cual tiene que ser muy potente y englobar la transformación de los avatares, el titulo tiene que tener un lenguaje personal con el que la persona se sienta identificado, el cual tiene que conectar con el usuario y con no más de 100 caracteres decirle al usuario el objetivo de esta pagina)",
            h2: "añade un subtitulo de 200 y 300 caracteres que amplie y responda la idea principal del titulo h1 anterior y haga que el usuario se sienta identificado con el objetivo de la landingpage, usa un lenguaje personal que conecte con el usuario, que se sienta conectado con la persona que ingresa a la pagina. usa un tono similar al que usaste en el h1, intenta incluir el titulo pero con el nombre del proyecto projectName del producto para el seo e identificacion por parte del usuario"
